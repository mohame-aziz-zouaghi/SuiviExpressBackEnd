...
public class ProductController {
    ...
    public List<Product> getByCategory(@PathVariable ProductCategories category) {
    ...
    public Product updateVisibility(@PathVariable Long id, @RequestParam boolean visible) {
